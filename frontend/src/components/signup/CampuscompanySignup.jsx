...
export default function CampuscompanySignup() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await axios.post(
                "http://localhost:5000/api/v1/campus/register", // Updated API endpoint for admin registration
                adminData
            );
            ...
            window.location.href = "http://localhost:3000/campuslogin";
        } catch (error) {
            if (error.response) {
        ...
        <div>
            <form className="form" onSubmit={handleSubmit}>
                <div className="leftcomp">
                    <span className="signup">Campus Company Sign Up</span> {/* Updated title */}
                    <input
                        type="text"
